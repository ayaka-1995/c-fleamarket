...
<form action="/address" method="post" class="address center"><!--purchaseと繋げられたら編集-->
    @csrf
    <h1 class="page__title">住所の変更</h1>
    <label for="postcode" class="entry__name">郵便番号</label>
    <input name="address" id="address" type="text" class="input" value="{{$user->profile->postcode}}" size="10" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');">
