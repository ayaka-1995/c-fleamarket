...
class PurchaseController extends Controller
{
    ...
    //         //ASCIIコードに日本語はないため、住所と建物はエンコードする必要あり⬇️
    ...
    //     if(!$request->url_id || !$request->amount || !$request->sending_postcode || !$request->sending_address){
    //         throw new Exception("You need all Query Parameters(user_id,amount,sending_postcode,sendind_address)");
    //     }
